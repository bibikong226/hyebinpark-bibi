                  ...
                  <MacWin title="About" delay={0.12}>
                    <div className="px-5 py-3 sm:p-5 md:p-6">
                      <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start sm:gap-4">
                        ...
                        <div>
                          <p className="text-center text-[14px] font-medium leading-[1.5] text-black/85 sm:text-left sm:text-[16px] sm:leading-[1.45]">I turn ambiguity into clear, trustworthy products that drive real business impact.</p>
