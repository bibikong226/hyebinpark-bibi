                  ...
                  <MacWin title="About" delay={0.12}>
                    <div className="px-5 py-3 sm:p-5 md:p-6">
                      <div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start sm:gap-4">
                        ...
                        <div>
                          <p className="text-center text-[14px] font-medium leading-[1.5] text-black/85 sm:text-left sm:text-[16px] sm:leading-[1.45]">I turn <span className="font-bold text-black">ambiguity</span> into clear, trustworthy products that drive <span className="font-bold text-black">real business impact</span>.</p>
                      ...
                      <div className="mt-4 border-t border-black/[0.05] pt-3 sm:mt-5 sm:pt-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                          {experienceLogos.map(logo => (
                            <img key={logo.alt} src={logo.src} alt={logo.alt} className="h-9 w-9 object-contain sm:h-12 sm:w-12" />
                          ))}
                        </div>
                      </div>
                    </div>
            ...
            <div className="mx-auto flex w-fit items-center gap-0 overflow-x-auto rounded-2xl px-2 py-2 sm:px-3" role="navigation" aria-label="Quick navigation dock"
              ...
              {(() => {
                const items = [
                  ...
                  { icon: "📄", label: "CV", bg: "linear-gradient(135deg,#FBBF24,#D97706)", action: () => window.open("https://drive.google.com/file/d/1wkG1WktHhUqwPqQp43WCjYOMFmRYPY9T/view?usp=sharing", "_blank") },
                ];
