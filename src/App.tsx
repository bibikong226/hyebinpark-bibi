...
const PuzzleShape = ({ variant, text, color, className }: { variant: string; text: string; color: string; className?: string }) => {
  // viewBox: 0 0 100 100
...
const App = () => {
  ...
  const finalGrid = [
    { x: 64, y: 78 },   // col 1 row 1
    { x: 184, y: 78 },  // col 2 row 1
    { x: 304, y: 78 },  // col 3 row 1
    { x: 64, y: 204 },  // col 1 row 2
    { x: 184, y: 204 }, // col 2 row 2
    { x: 304, y: 204 }, // col 3 row 2
  ];

  const puzzlePieces = [
    { id: 1, text: "What users say", variant: "P1", color: "#FF6B6B", messy: { x: "6vw", y: "-14vh", r: -28 }, final: { ...finalGrid[0], r: 0 }, delay: 0.0 },
    { id: 2, text: "What data shows", variant: "P2", color: "#4D96FF", messy: { x: "28vw", y: "-10vh", r: 42 }, final: { ...finalGrid[1], r: 0 }, delay: 0.12 },
    { id: 3, text: "What business wants", variant: "P3", color: "#6BCB77", messy: { x: "18vw", y: "22vh", r: 140 }, final: { ...finalGrid[2], r: 0 }, delay: 0.24 },
    { id: 4, text: "What tech allows", variant: "P4", color: "#FFD93D", messy: { x: "2vw", y: "14vh", r: -12 }, final: { ...finalGrid[3], r: 0 }, delay: 0.36 },
    { id: 5, text: "What breaks", variant: "P5", color: "#B983FF", messy: { x: "34vw", y: "26vh", r: 96 }, final: { ...finalGrid[4], r: 0 }, delay: 0.48 },
    { id: 6, text: "What we don't know", variant: "P6", color: "#FF8FAB", messy: { x: "14vw", y: "34vh", r: -78 }, final: { ...finalGrid[5], r: 0 }, delay: 0.60 },
  ];
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col md:flex-row items-center px-8 md:px-16">
          ...
          <div className="w-full md:w-3/5 z-10">
            ...
            >
              ...
              <h1 className="text-[3.2rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.5rem] font-light tracking-tighter leading-none mb-10">
                Hyebin Park
              </h1>
              <h3 className="text-xl md:text-2xl text-zinc-500 font-light leading-relaxed max-w-xl mb-8">
                Strategic product designer who turns <span className="font-serif italic text-indigo-600">complex, messy problems</span> into business impact.
              </h3>
              <p className="text-zinc-400 leading-relaxed max-w-lg font-light">
                From AI algorithms to crypto workflows, I bring research-backed insight, empathy, and a human touch to emerging technologies.
              </p>
            </motion.div>
          </div>
