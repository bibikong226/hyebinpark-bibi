        ...
        <div className="mx-auto max-w-[640px] text-center">
          ...
          >
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              ...
              <a href="https://www.linkedin.com/in/hyebinp/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3 text-[14px] font-medium text-white/70 transition-all hover:bg-white/10">
