...
const About = () => {
  return (
    <div className="bg-background text-foreground min-h-screen font-sans">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-4 sm:px-8 md:px-16 py-6 sm:py-8 md:py-10"
        style={{ background: "rgba(255,255,255,.8)", backdropFilter: "blur(20px) saturate(1.5)" }}>
        <Link to="/" className="font-semibold tracking-tight text-lg sm:text-xl uppercase text-foreground">Hyebin Park</Link>
        <div className="hidden md:flex items-center gap-4 lg:gap-8 text-[10px] uppercase tracking-[0.3em] font-medium text-foreground">
          ...
          <Link to="/about" className="hover:opacity-60 transition-all text-primary">About</Link>
          <a href="/cv" className="hover:opacity-60 transition-all">CV</a>
          <a href="https://www.linkedin.com/in/hyebinp/" target="_blank" rel="noopener noreferrer" className="px-4 lg:px-5 py-2 bg-primary text-primary-foreground rounded-full hover:opacity-90 transition-all normal-case text-xs sm:text-sm tracking-normal font-medium">Contact</a>
        </div>
      </nav>
      ...
      <section className="pt-28 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-8 md:px-16">
        <div className="max-w-6xl mx-auto">
          <motion.h1 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif italic text-primary mb-8 sm:mb-12 md:mb-16"
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-start p-6 sm:p-8 md:p-10">
              ...
              >
                ...
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  I'm a <span className="font-semibold text-foreground">strategic product designer</span> who turns complex problems in <span className="font-semibold text-foreground">emerging tech</span> into tangible <span className="font-semibold text-foreground">business impact</span>. I use research-backed insight to bring a human touch to powerful new systems, from AI algorithms to crypto workflows.
                </p>
                <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
                  As a Master's student in <span className="font-semibold text-foreground">Human-Computer Interaction</span> at the University of Michigan, I specialize in bridging the gap between <span className="font-semibold text-foreground">user needs, technical possibilities, and business goals</span>.
                </p>
                <a 
                  href="https://drive.google.com/file/d/1l2V4pQCjAZhIhLyRmVh3m2QTw87yLI6P/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-foreground text-background rounded-full hover:opacity-90 transition-all font-medium text-sm sm:text-base mt-4"
                >
                  View Resume
      ...
      {/* Experience Section */}
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 bg-secondary/50">
        <div className="max-w-6xl mx-auto">
          <motion.h2 
                ...
                <MacWindow>
                  <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-center sm:items-start p-5 sm:p-6">
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      ...
                      <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-foreground mt-2 mb-3 sm:mb-4">{exp.title}</h3>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16">
        <div className="max-w-6xl mx-auto">
          <motion.h2 
            className="text-2xl sm:text-3xl md:text-4xl font-medium text-foreground mb-10 sm:mb-12 md:mb-16"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
              ...
              >
                <MacWindow>
                  <div className="p-6 sm:p-8">
                    <h3 className="text-xl sm:text-2xl font-serif italic text-primary mb-3 sm:mb-4">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 bg-secondary/50">
        <div className="max-w-6xl mx-auto">
          <motion.h2 
            className="text-2xl sm:text-3xl md:text-4xl font-medium text-foreground mb-8 sm:mb-10 md:mb-12"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            ...
            {hobbies.map((hobby, index) => (
              ...
              >
                <MacWindow>
                  ...
                  <p className="text-muted-foreground text-xs sm:text-sm leading-relaxed p-3">{hobby.caption}</p>
                </MacWindow>
              </motion.div>
            ))}
          </div>
      ...
      {/* Connect Section */}
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-8 md:px-16 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-4 sm:space-y-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium">Let's Connect</h2>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mt-6 sm:mt-8">
              <a href="mailto:hyebinp@umich.edu" className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-background text-primary rounded-full hover:opacity-90 transition-all font-medium text-sm sm:text-base">
                hyebinp@umich.edu <ArrowUpRight className="w-4 h-4" />
              </a>
              <a href="https://www.linkedin.com/in/hyebinp/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-primary-foreground/10 text-primary-foreground border border-primary-foreground/30 rounded-full hover:bg-primary-foreground/20 transition-all font-medium text-sm sm:text-base">
      ...
      {/* Footer */}
      <footer className="py-6 sm:py-8 px-4 sm:px-8 md:px-16 bg-foreground text-background/60 text-center text-xs sm:text-sm">
